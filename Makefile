...
ARCH		:= arm64
CROSS_COMPILE	:= /home/w4tch0ut/aarch64-linux-gnu-6.0/bin/aarch64-
...
EXTRA_FLAGS := -Ofast -fgcse-sm -Wno-array-bounds -Wno-error=strict-overflow -fuse-linker-plugin -pipe -DNDEBUG -mtune=cortex-a53 -mcpu=cortex-a53 -march=armv8-a -fmodulo-sched -fmodulo-sched-allow-regmoves -fprefetch-loop-arrays -fstrict-aliasing -Werror=strict-aliasing

# Make variables (CC, etc...)

AS		= $(CROSS_COMPILE)as
LD		= $(CROSS_COMPILE)ld
CC		= ccache $(CROSS_COMPILE)gcc $(EXTRA_FLAGS)
CPP		= $(CC) -E
AR		= $(CROSS_COMPILE)ar
NM		= $(CROSS_COMPILE)nm
...
KERNEL_FLAGS	= -pipe -DNDEBUG -Ofast -mtune=cortex-a53 -mcpu=cortex-a53
